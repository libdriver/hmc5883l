...
LibDriver HMC5883Lは、LibDriverによって発売されたHMC5883Lのフル機能のドライバーであり、連続モードの磁場強度の読み取り、シングルモードの磁場の読み取り、およびその他の機能を提供し、MISRAに準拠しています。
...
オンラインドキュメント: https://www.libdriver.com/docs/hmc5883l/index.html
